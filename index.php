...
'.
        ...
        $message .=
        'Obrigado pelo contato, aguardamos a sua visita.'.
        '</body>
        </html>';
    ...
    <div class="container-full" role="main">
      ...
      <section class="row start" id="home">
        <div class="container-congresso-mpd">
          <div class="col-md-12">
            <center>
              <h1><img src="img/logo-congresso-mpd.png" class="img-mobile" border="0" alt="" /></h1>
              <br />
          ...
          <div class="col-md-12 ">
            <center>
              <form>
                ...
                <input type="text" value="" placeholder="E-mail" name="email" /><button type="button">OK</button>
              </form>
            </center>
          </div>
        </div>
      ...
      <section class="row mpd-intro" id="sobre">
        <div class="container-congresso-mpd">
          <div class="col-md-12">
            <br />
            <br />
            <center><img src="img/mpd-logo.png" class="img-mobile" /></center>
            <br />
            <br />
            <div class="col-md-12">
            ...
            <center>
              <ul>
                <li>
                  ...
                  <h4>São Paulo<br />
                  <span class="grey">24 a 26 de Agosto de 2016</span></h4>
                </li>
                <li>
                  <img src="img/pin.png" border="0" alt="" /><br />
                  <h4>WZ Hotel<br />
                  <span class="grey">
                    <strong>Av. Rebouças, 955 - Jardins</strong><br />
                    (próx. Avenida Paulista)</span></h4>
                </li>
                <li>
                  <img src="img/coordinator.png" border="0" alt="" /><br />
                  <h4>Coordenação Executiva<br />
                  <span class="grey"><strong>Laila Shukair</strong> | Presidente do MPD</span></h4>
                  <h4>Coordenação científica<br />
                  <span class="grey"><strong>Roberto Livianu</strong></span></h4>
                </li>
              </ul>
            </center>
          </div>
...
              ** É necessário o envio de carteirinha de estudante para o e-mail mpdemocratico@terra.com.br no ato da inscrição</li>
      ...
      <section class="row">
        <div class="container-congresso-mpd">
          ...
          <br />
          <br />
          <center><img src="img/lancamento.jpg" class="img-mobile" border="0" alt="" /></center>
          <br />
          <br />
          <br />
        </div>
      ...
      <section class="row program" id="programacao">
        <div class="container-congresso-mpd">
          ...
          <center>
            ...
            <span class="green twenty-four">8h | Credenciamento <br />e retirada do material</span></h4>
          </center>
          ...
          <ul class="col-md-12 program-agenda">
            ...
            <li class="col-md-4">
              <center><img src="img/25-9h.png" border="0" alt="" /></center><br />
              <p class="white thirty">2. Os desafios sociais das promessas não cumpridas da democracia. MP em defesa dos mais vulneráveis socialmente.</p>
...
Heródoto Barbeiro | Jornalista e Apresentador Record News<br /><br />
          ...
          <ul class="col-md-12 program-agenda">
            <li class="col-md-4">
              ...
              <p class="white thirty">4. Por uma Justiça para o povo:
                desafios para mpliação do acesso à justiça.<br /><br /></p>
              <p class="green"><strong>Sala Jardim I</strong></p>
              <br />
              <p class="dark-blue">
                <strong>Presidente</strong><br />
                ...
                <br />
                <strong>Expositores</strong><br />
                Maria Tereza Sadek | Cientista política USP<br />
                Fábio Bastos Stica | ex-Procurador Geral de Justiça MP-RR e Conselheiro CNMP<br /><br />
                <strong>Convidado Especial</strong><br />
                Sérgio Renault | Presidente do Prêmio Innovare<br /><br />
                <strong>Tópicos</strong><br />
                questão territorial, MP itinerante, aproximação com a sociedade. Crescente judicialização dos conflitos.
            </li>
            <li class="col-md-4">
              <center><img src="img/25-14h.png" border="0" alt="" /></center><br />
              <p class="white thirty">5. Novas gerações do MP: agentes burocráticos ou agentes políticos de transformações sociais? O modelo de formação dos membros do MP no Brasil é adequado?</p>
              <p class="green"><strong>Sala Jardim II</strong></p>
              <br />
              <p class="dark-blue">
              <strong>Presidente</strong><br />
              ...
              <strong>Expositores</strong><br />
              Eduardo Diniz Neto | Promotor de Justiça MP-PR e ex-Presidente CEDEP<br />
							Roberto Romano | Filósofo</br /><br />
              <strong>Convidado Especial</strong><br />
              Sabine Righetti | Jornalista Folha de S. Paulo<br /><br />
              <strong>Tópicos</strong><br />
              visão social e humanista, seleção, curso de adaptação, formação continuada/acompanhamento e formação complementar.
            </li>
            <li class="col-md-4">
              <center><img src="img/25-14h.png" border="0" alt="" /></center><br />
              <p class="white thirty">6. A tragédia social e cultural da corrupção endêmica, que bloqueia a concretização de políticas públicas. Estamos apenas tocando a ponta do “iceberg”. Faltam pernas, coragem ou ndependência das cúpulas do MP para responsabilizar os do “andar de cima”?</p>
              <p class="green"><strong>Sala Jardim III</strong></p>
              <br />
              <p class="dark-blue">
              <strong>Presidente</strong><br />
              Fábio George Cruz da Nóbrega | Procurador da República e Conselheiro CNMP<br /><br />
              <strong>Expositores</strong><br />
              Roberto Livianu | Promotor de Justiça MP-SP e Presidente do Inst. Não Aceito Corrupção<br />
							Silvio Caccia Bava | Diretor e editor-chefe do Le Monde Diplomatique Brasil<br /><br />
              <strong>Convidado Especial</strong><br />
              José Álvaro Moysés | Cientista Político USP <br /><br />
              <strong>Tópicos</strong><br />
              investigação, ação anticorrupção em rede, competência originária, prevenção, ativismo
            </li>
          </ul>
          ...
          <center>
            ...
            <span class="green twenty-four">8h | Credenciamento <br />e entrega dos vouchers</span></h4>
          </center>
      ...
      <section class="row speechers" id="palestrantes">
        <div class="container-congresso-mpd">
          ...
          <article class="col-md-4">
            ...
            <span class="white">Procurador</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Advogada</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Advogado</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Ex-Procurador</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Corregedor</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Promotor</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Coordenadora</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Subprocurador</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Procuradora</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Promotora</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Economista</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Jornalista</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Cientista</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Auditora</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Socióloga</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Doutora</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Corregedor-Geral</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Defensor Público</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Professor</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Cientista Social</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Sociólogo</span></h4>
          ...
          <article class="col-md-4">
            ...
            <span class="white">Vice-Corregedora-Geral</span></h4>
        ...
        <div class="container-congresso-mpd">
          ...
          <center><p class="white">Esta área é reservada para você!<br />
            ...
            <ul class="col-md-12">
              ...
              <li class="col-md-4"><input type="text" placeholder="E-mail" name="mail" /></li>
              <li class="col-md-4"><input type="text" placeholder="Telefone" name="phone" /></li>
              <li class="col-md-12">
                <textarea placeholder="Mensagem" name="mensagem"></textarea>
                <center><button type="submit">ENVIAR</button></center>
              </li>
              <li class="col-md-12 white twenty"><input type="checkbox" />Adicionar ao mailing</li>
            </ul>
          </form>
          <?php
                  } // fecha else
        ...
        <div class="container-congresso-mpd">
          <div class="col-md-10">
            ...
            <ul class="col-md-12">
              ...
              <li>
                <input type="text" placeholder="E-mail" /><button>OK</button>
              </li>
            </ul>
